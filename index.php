...
<body>
    ...
    <div class="container">
        ...
        <!-- Menu TENGAH - Absolute positioning untuk pusat sempurna -->
            ...
            <div class="py-4 border-top">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-center text-md-end mt-2 mt-md-0">
                        <img src="https://upload.wikimedia.org/wikipedia/id/0/0d/Logo_Universitas_Pembangunan_Nasional_Veteran_Yogyakarta.png" alt="UPN" height="25" class="opacity-50 grayscale me-3">
